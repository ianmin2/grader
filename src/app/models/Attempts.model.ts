...
export class Attempts
{
  ...
  constructor(
{ attempt_id, attempt_name, attempt_student_identifier, attempt_main_path, attempt_submission_time, attempt_grading_time, attempt_grade, attempt_grade_breakdown, attempt_grade_complete, attempt_assignment, attempt_assignment_data, created_at, updated_at }: { attempt_id: Number; attempt_name: string; attempt_student_identifier: string; attempt_main_path: string; attempt_submission_time: Date; attempt_grading_time: Date; attempt_grade?: any; attempt_grade_breakdown: any; attempt_grade_complete: boolean; attempt_assignment: Number; attempt_assignment_data?: Assignment; created_at?: Date; updated_at?: Date; })
    {
      ...
      this.attempt_grade = attempt_grade;
